...
void book_Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->on_signal_init_book_dialog(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&book_Dialog::signal_load_bookItem)) {
                *result = 0;
            }
        }
        {
...
// SIGNAL 0
void book_Dialog::signal_load_bookItem(int _t1)
{
