/********************************************************************************
** Form generated from reading UI file 'managebook_dialog.ui'
**
...
#ifndef UI_MANAGEBOOK_DIALOG_H
#define UI_MANAGEBOOK_DIALOG_H
...
public:
    ...
    void setupUi(QDialog *manageBook_Dialog)
    {
        if (manageBook_Dialog->objectName().isEmpty())
            manageBook_Dialog->setObjectName(QStringLiteral("manageBook_Dialog"));
        manageBook_Dialog->resize(702, 420);
        group_booklist = new QGroupBox(manageBook_Dialog);
        ...
        group_add_single = new QGroupBox(manageBook_Dialog);
        ...
        label_9->raise();
        single_title->raise();
        group_nav = new QGroupBox(manageBook_Dialog);
        ...
        retranslateUi(manageBook_Dialog);

        QMetaObject::connectSlotsByName(manageBook_Dialog);
    } // setupUi
    ...
    void retranslateUi(QDialog *manageBook_Dialog)
    {
        ...
        label_2->setText(QApplication::translate("manageBook_Dialog", "\345\233\276\344\271\246\347\261\273\345\236\213\357\274\232", 0));
        single_pub_press->setText(QString());
        label_3->setText(QApplication::translate("manageBook_Dialog", "\345\207\272\347\211\210\347\244\276\357\274\232", 0));
        label_4->setText(QApplication::translate("manageBook_Dialog", "\345\271\264\344\273\275\357\274\232", 0));
        single_pub_year->setText(QString());
        label_5->setText(QApplication::translate("manageBook_Dialog", "\345\215\225\344\273\267\357\274\232", 0));
        single_price->setText(QString());
        label_6->setText(QApplication::translate("manageBook_Dialog", "\344\275\215\347\275\256\357\274\232", 0));
        single_location->setText(QString());
        single_num_total->setText(QApplication::translate("manageBook_Dialog", "1", 0));
        label_7->setText(QApplication::translate("manageBook_Dialog", "\346\225\260\351\207\217\357\274\232", 0));
        single_add->setText(QApplication::translate("manageBook_Dialog", "\346\267\273\345\212\240", 0));
        single_clear->setText(QApplication::translate("manageBook_Dialog", "\346\270\205\347\251\272", 0));
        label_8->setText(QApplication::translate("manageBook_Dialog", "\344\275\234\350\200\205\357\274\232", 0));
        single_author->setText(QString());
        single_isbn->setText(QString());
        label_9->setText(QApplication::translate("manageBook_Dialog", "ISBN\357\274\232", 0));
        group_nav->setTitle(QApplication::translate("manageBook_Dialog", "\346\223\215\344\275\234\351\200\211\351\241\271", 0));
        guide_add_batch->setText(QApplication::translate("manageBook_Dialog", "\346\211\271\351\207\217\346\267\273\345\212\240", 0));
        guide_booklist->setText(QApplication::translate("manageBook_Dialog", "\345\233\276\344\271\246\345\210\227\350\241\250", 0));
        guide_add_single->setText(QApplication::translate("manageBook_Dialog", "\345\215\225\345\206\214\346\267\273\345\212\240", 0));
    } // retranslateUi

};

namespace Ui {
    class manageBook_Dialog: public Ui_manageBook_Dialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_MANAGEBOOK_DIALOG_H
