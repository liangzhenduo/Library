...
public:
    ...
    void setupUi(QDialog *user_manage_Dialog)
    {
        ...
        newuser_add_Button->setGeometry(QRect(220, 220, 96, 36));
        ...
        newuser_isadmin->setGeometry(QRect(270, 180, 128, 30));
    ...
    void retranslateUi(QDialog *user_manage_Dialog)
    {
        ...
        group_newuser->setTitle(QApplication::translate("user_manage_Dialog", "\346\267\273\345\212\240\346\226\260\347\224\250\346\210\267", 0));
        ...
        newuser_num_limit->setText(QApplication::translate("user_manage_Dialog", "7", 0));
        ...
        label_8->setText(QApplication::translate("user_manage_Dialog", "\351\203\250\351\227\250\357\274\232", 0));
        manage_department->setText(QString());
        manage_num_limit->setText(QApplication::translate("user_manage_Dialog", "10", 0));
