...
public:
    ...
    void setupUi(QDialog *user_Dialog)
    {
        ...
        old_password->setGeometry(QRect(400, 25, 128, 24));
        ...
        change_Button->setGeometry(QRect(380, 125, 96, 30));
        label = new QLabel(groupBox);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(330, 30, 54, 12));
        label_2 = new QLabel(groupBox);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(330, 65, 54, 12));
        label_3 = new QLabel(groupBox);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(330, 100, 54, 12));
