...
QT_MOC_LITERAL(1, 12, 18), // "onsignal_load_item"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 4), // "isbn"
QT_MOC_LITERAL(4, 37, 19), // "on_bookview_clicked"
QT_MOC_LITERAL(5, 57, 5) // "index"

    },
    "item_Dialog\0onsignal_load_item\0\0isbn\0"
    "on_bookview_clicked\0index"
};
...
void item_Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        item_Dialog *_t = static_cast<item_Dialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onsignal_load_item((*reinterpret_cast< QString(*)>(_a[1]))); break;
...
const QMetaObject item_Dialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_item_Dialog.data,
      qt_meta_data_item_Dialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *item_Dialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_item_Dialog.stringdata0))
        return static_cast<void*>(const_cast< item_Dialog*>(this));
